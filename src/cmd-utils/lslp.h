...
#define _LSLP_INIT_HEAD(x) (x)->prev = x;	\
		(x)->next = x;			\
		(x)->isHead = 1;		\
...
#define _LSLP_SETLONGLONG(h, i, o)		\
  {						\
    _LSLP_SETLONG((uint8*)h, (i >> 32), (o)) ;		\
    _LSLP_SETLONG((uint8*)h, (i & 0xffffffff), (o) + 4);	\
  }							\
    
#define _LSLP_GETLONGLONG(h, o) \
  ( 0xffffffff00000000 & ( _LSLP_GETLONG((uint8*)h, (o)) << 32) ) +	\
  ( 0xffffffff & ( _LSLP_GETLONG((uint8*)h, (o) + 4 ) ) ) 
...
#define _LSLP_SETLONGLONG(h, i, o)		\
  {						\
    _LSLP_SETLONG((uint8*)(h), (0xffffffff00000000 & (i)), (o)) ;	\
    _LSLP_SETLONG((uint8*)(h), (0xffffffff & (i)), (o) + 4);		\
  }
      
#define _LSLP_GETLONGLONG(h, i, o) \
  ((0xffffffff00000000 & ( _LSLP_GETLONG((uint8*)(h), (o) ))) + \
   (0xffffffff & _LSLP_GETLONG((uint8*)(h), (o) + 4) ))
